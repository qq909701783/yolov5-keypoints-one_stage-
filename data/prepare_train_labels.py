...
def Main(label_path,input_size):
    ...
    prepared_annotations = prepare_annotations(annotations_per_image_mapping, images_info, input_size)

    return prepared_annotations

if __name__ == '__main__':
    label_path = r'../tmp/person_keypoints_train2017.json'
    input_size = 512
    anns = Main(label_path,input_size)

    # parser = argparse.ArgumentParser()
    # parser.add_argument('--labels', type=str, default=r'/media/root/fc6cf683-9c07-46ff-a325-9115b0701844/root/LIKE/关键点检测/HigherHRNet-Human-Pose-Estimation-master/person_keypoints_train2017.json', help='path to json with keypoints train labels')
    ...
    # parser.add_argument('--net-input-size', type=int, default=512, help='network input size')
